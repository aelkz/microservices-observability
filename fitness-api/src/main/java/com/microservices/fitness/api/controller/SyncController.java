package com.microservices.fitness.api.controller;

import com.microservices.fitness.api.controller.validator.EventValidator;
import com.microservices.fitness.api.instrument.metrics.ActivityMetrics;
import com.microservices.fitness.api.instrument.tracer.ActivityTracer;
import com.microservices.fitness.api.service.async.calendar.ReactiveCalendarIntegrationService;
import com.microservices.fitness.api.service.async.medical.CardiologistIntegrationService;
import com.microservices.fitness.api.service.async.medical.NutritionistIntegrationService;
import com.microservices.fitness.api.service.async.social.StravaIntegrationService;
import com.microservices.fitness.api.model.Activity;
import com.microservices.fitness.api.service.ActivityService;
...
public class SyncController extends BaseController {
    ...
    private final ReactiveCalendarIntegrationService calendarIntegrationService;
    ...
    public SyncController(
            ...
            ReactiveCalendarIntegrationService calendarIntegrationService,
    ...
    @ApiOperation(
            value = "Sync fitness user data across linked 3rd party software",
            notes = "The fitness user data will be sent to all devices registered in the account user preferences.",
    ...
    public ResponseEntity<Activity> sync(@Valid @RequestBody Activity activity) {
        ...
        Span span1 = tracer.startChildSpan(rootSpan,"reactive.calendar.async.svc");
