...
public class Event extends BaseModel {
    ...
    public Event(@NotNull @Size(min = 5, max = 255, message = "E-mail must be between 5 and 255 characters") String email, @NotNull String handle, @NotNull LocalDate birthDate, @NotNull Gender gender, @NotNull Double calories, @NotNull String sportId, @NotNull LocalDateTime startDate, @NotNull LocalDateTime endDate, @NotNull @Min(value = 30, message = "Heart rate avg should not be less than 30") @Max(value = 220, message = "Heart rate avg should not be greater than 220") Integer hrAvg, @NotNull @Min(value = 30, message = "Heart rate min should not be less than 30") @Max(value = 220, message = "Heart rate min should not be greater than 220") Integer hrMin, @NotNull @Min(value = 30, message = "Heart rate max should not be less than 30") @Max(value = 220, message = "Heart rate max should not be greater than 220") Integer hrMax, @NotNull @Min(value = 1, message = "Training load should not be less than 1 hour") @Max(value = 168, message = "Training load should not be greater than 168 hours") Integer load, String notes) {
        this.email = email;
        this.handle = handle;
